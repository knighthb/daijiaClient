...
@property (nonatomic, strong) UIColor *fontColorDisabled;
@property (nonatomic, strong) UIColor *fontColorEnabled;
@property (nonatomic, strong) UIColor *currentStateFontColor;
