...
//        }
        ...
        if ( [self respondsToSelector:@selector(setAttributedTitle:forState:)]) {
            ...
            [self setTitle:[self buttonText] forState:state];
            [self setTitleColor:[textAttributes objectForKey:@"NSForegroundColorAttributeName" ] forState:state ];
            self.titleLabel.font = [textAttributes objectForKey:@"NSFontAttributeName" ] ;
        }
    }
}
